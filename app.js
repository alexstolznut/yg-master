...
var yongtaiApp = angular.module('yongtaiApp', ['shopModule']);

//Define a controller on our yongtai application.
//Import the necessary services to the controller
yongtaiApp.controller('ProductController', ['shopService', '$scope', function ProductController(shopService, $scope) {

    /* Local scope variables for user login and customer history review */
    $scope.username = {
        text: 'email',
        word: /^\w*@\w*$/
    }
